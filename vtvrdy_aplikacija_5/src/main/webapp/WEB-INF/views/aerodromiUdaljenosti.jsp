...
<form action="${pageContext.servletContext.contextPath}/mvc/aerodromi/aerodromiUdaljenosti"  method="get">
...
%>
  ...
  <br><p><strong>Ukupno = <%=ukupno %></strong></p>
    <%}else { %>
  <div>Ovdje se nema što prikazati!</div>
