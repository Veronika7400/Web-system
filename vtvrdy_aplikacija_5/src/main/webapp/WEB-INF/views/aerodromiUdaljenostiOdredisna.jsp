...
<head>
<meta charset="UTF-8">
<title>Pregled manjih udaljenosti u odredišnoj državi</title>
<style>
table {
...
<body>
  <div  class="info">
    ...
    ${infoGodina}</t>
    ${infoVerzija}</t>
    <h1>Pregled manjih udaljenosti u odredišnoj državi</h1> 
  </div><br>
 
  <button class="gumb"> <a href = ${pageContext.servletContext.contextPath} >Početna stranica</a></button><br>
    <br>
<form action="${pageContext.servletContext.contextPath}/mvc/aerodromi/udaljenostOdredisna"  method="get">
